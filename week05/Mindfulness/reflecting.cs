...
public class ReflectingActivity : Activity
{
    private List<string> _prompts = new List<string> {        
        ...
        "Think of an experience where you demonstrated selflessness.",
        "Think of a time when you took a risk for a worthy cause.",
        ...
        "Think of a moment when you confronted an injustice.",
        "Think of an experience where you demonstrated empathy towards someone in distress.",
        "Think of a memory when you shared your knowledge to benefit others.",
    };
